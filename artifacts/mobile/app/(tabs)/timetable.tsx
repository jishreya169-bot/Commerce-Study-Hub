  ...
  const fetchSchedule = async () => {
    ...
    try {
      const res = await turso.execute({
        sql: "SELECT t.id, t.title, t.batch, t.startTime, t.endTime, t.type, t.color, t.dayOfWeek, t.date, u.name as teacherName FROM timetable t LEFT JOIN users u ON t.teacherId = u.id WHERE t.batch = ?",
        args: [user.batch]
      });
